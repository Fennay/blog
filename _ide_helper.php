 ...
 * Generated for Laravel 5.5.27 on 2018-01-02.
 *
...
namespace  { 
    ...
    class Eloquent extends \Fennay\ModelHelper\Model {         
            /**
             ...
             * @static 
             */ 
            public static function getList($where, $size = 0, $order = array(), $skip = 0)
            {    
            ...
            {    
                return \Fennay\ModelHelper\HelperQueryBuilder::del($id);
            }
