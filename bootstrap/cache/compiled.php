...
class ErrorHandler
{
    ...
    {
        $this->handleError(E_USER_DEPRECATED, 'The ' . __METHOD__ . ' method is deprecated since version 2.6 and will be removed in 3.0. Use the handleError() method instead.', '/webser/www/projects/Laravel/Framework/Laravel5.1/vendor/symfony/debug/ErrorHandler.php', __LINE__, array());
...
class Carbon extends DateTime
{
    ...
    public static function setLocale($locale)
    {
        ...
        static::translator()->addResource('array', require '/webser/www/projects/Laravel/Framework/Laravel5.1/vendor/nesbot/carbon/src/Carbon' . '/Lang/' . $locale . '.php', $locale);
    }
