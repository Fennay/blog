...
<head>
    ...
    <link href="/resources/admin/assets/pages/css/login-5.min.css" rel="stylesheet" type="text/css"/>
...
<div class="user-login-5">
    <div class="row bs-reset">
        <div class="col-md-6 bs-reset mt-login-5-bsfix">
            <div class="login-bg" style='background-image:url("/resources/admin/assets/pages/img/login/bg1.jpg")'>
                <img class="login-logo" src="/resources/admin/assets/pages/img/login/logo.png"/></div>
        </div>
                ...
                <div class="row bs-reset">
                    <div class="col-xs-7 bs-reset">
                        <div class="login-copyright text-right">
                            <p>Copyright &copy; Mikey Designd by keenthemes 2017</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script src="/resources/admin/assets/global/plugins/jquery-validation/js/jquery.validate.min.js"
        type="text/javascript"></script>
<script src="/resources/admin/assets/global/plugins/jquery-validation/js/additional-methods.min.js"
        type="text/javascript"></script>
