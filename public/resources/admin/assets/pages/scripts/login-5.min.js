var Login = function () {
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["/resources/admin/assets/pages/img/login/bg1.jpg", "/resources/admin/assets/pages/img/login/bg2.jpg", "/resources/admin/assets/pages/img/login/bg3.jpg"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
